...
// fetch all list
export const fetchOfferlistData = createAction('[Data] fetch Offerlist',props<{ page: number; itemsPerPage: number,query: string, category: string, startDate?: string, endDate?: string, company_id?: number, status?: string }>());
