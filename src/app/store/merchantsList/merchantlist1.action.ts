...
// fetch all list
export const fetchMerchantlistData = createAction('[Data] fetch Merchantlist', props<{ page?: number; itemsPerPage?: number,query?: string, country_id?: number, status?: string }>());
