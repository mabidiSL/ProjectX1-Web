...
export class InvoicesEffects {
    ...
    fetchData$ = createEffect(() =>
        this.actions$.pipe(
            ...
            mergeMap(({ page, itemsPerPage, query, category, dueDate, status }) =>
                this.CrudService.fetchData('/invoices',{ limit: itemsPerPage, page: page,query: query, category: category, dueDate: dueDate,status: status}).pipe(
